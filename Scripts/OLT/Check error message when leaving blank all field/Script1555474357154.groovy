...
WebUI.verifyMatch(errormess2, 'The ip address field is required.', false)

WebUI.verifyMatch(errormess3, 'The user name field is required.', false)

WebUI.verifyMatch(errormess4, 'The password field is required.', false)
