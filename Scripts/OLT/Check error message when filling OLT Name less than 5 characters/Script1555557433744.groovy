...
WebUI.setText(findTestObject('Object Repository/OLT/Textbox/input_OLT Name_name'), 'Demo')

WebUI.setText(findTestObject('OLT/Textbox/input_IP Address_ip_address'), '175.67.54.5')

WebUI.setText(findTestObject('Object Repository/OLT/Textbox/input_Username_user_name'), '123456')
...
def errormess1 = WebUI.getText(findTestObject('Object Repository/OLT/Error Mess/errormess_name'))

WebUI.verifyMatch(errormess1, 'The Name must be at least 5 characters.', false)
