...
def errormess1 = WebUI.getText(findTestObject('Object Repository/OLT/Error Mess/blank_password'))

WebUI.verifyMatch(errormess1, 'The password field is required.', false)
