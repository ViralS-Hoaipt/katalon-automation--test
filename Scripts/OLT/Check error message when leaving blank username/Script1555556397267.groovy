...
def errormess1 = WebUI.getText(findTestObject('Object Repository/OLT/Error Mess/blank_Username'))

WebUI.verifyMatch(errormess1, 'The user name field is required.', false)
